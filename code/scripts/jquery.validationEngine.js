...
jQuery.fn.validationEngine = function(settings) {
	if($.validationEngineLanguage){					// IS THERE A LANGUAGE LOCALISATION ?
		...
		allRules = {"required":{    			  // Add your regex rules here, you can take telephone as an example
						...
						"requestor":{
							"regex":"/^(Name|[a-zA-Z\ \.\']*)$/",
							"alertText":"Please type in the requestor."},
						"priority":{
							"regex":"/^[High\Medium\Low]+$/",
							"alertText":"Please set the priority."},
						"industry":{
							"regex":"/^[Automotive\Banking\FMCG\Retail Apparel\Retail Food (QSR)\Retail Food (CDR)]+$/",
							"alertText":"Please select an industry."},
						"onlyLetterForDescription":{
							"regex":"/^(Name|[a-zA-Z\ \.\']*)$/",
							"alertText":"Please type in the description."},
						"onlyNumber":{
							"regex":"/^[0-9\ ]+$/",
						...
						"onlyLetter":{
							"regex":"/^(Name|[a-zA-Z\ \']*)$/",
							"alertText":"Please type in an English name."},
						"onlyLetterForIndustry":{
							"regex":"/^(Name|[a-zA-Z\ \']*)$/",
							"alertText":"Please type in your industry."},
						"onlyLetterForMessage":{
							"regex":"/^(Name|[a-zA-Z\ \']*)$/",
							"alertText":"Please type in your questions or comments."},
						"onlyLetterForDescription":{
							"regex":"/^(Name|[a-zA-Z\ \']*)$/",
							"alertText":"Please type in the description."},
					    "checkName":{

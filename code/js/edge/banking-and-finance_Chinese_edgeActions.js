...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_but_RetailIntensity_12}", "click", function(sym, e) {
         
         sym.getSymbol("mapbundle").getSymbol("Heatmap").play();// insert code for mouse click here

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_But_RetailPOI_12}", "click", function(sym, e) {
         sym.getSymbol("mapbundle").getSymbol("POI_ALL").play();// insert code for mouse click here
